...
- The `docs/` directory is generated by Vite and used for GitHub Pages deployment. If you need to add static files (e.g., CNAME for custom domains), place them in `docs/` after building, or add them to `browser-src/public/` to have Vite copy them automatically
